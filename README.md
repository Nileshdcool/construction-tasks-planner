...
To achieve the 20-25 hour development target, focus on these core features in order:

### Phase 1: Foundation (4-5 hours)
1. **Basic Project Setup**: React + TypeScript + Tailwind CSS
2. **Simple Database**: Local storage or basic IndexedDB for tasks
3. **Basic Authentication**: Username-only login with localStorage persistence
4. **Core Routing**: Simple page navigation

### Phase 2: Essential Task Management (6-8 hours)
1. **Task CRUD**: Create, read, update, delete tasks
2. **Basic Task List**: Simple table or card view
3. **Essential Fields**: Title, description, status (3 states: todo, doing, done)
4. **Simple Form**: Basic task creation and editing

### Phase 3: Basic Floor Plan (4-5 hours)
1. **Image Upload**: Simple file input and display
2. **Click-to-Add**: Click on image to create task at that position
3. **Basic Markers**: Simple dots or icons showing task locations
4. **Position Storage**: Store X,Y coordinates with tasks

### Phase 4: Simple Checklist (3-4 hours)
1. **Checklist Model**: Add checklist items to tasks
2. **Checkbox Interface**: Simple list of checkboxes
3. **Basic Progress**: Show completed/total items

### Phase 5: Minimal Dashboard (2-3 hours)
1. **Task Counts**: Display total tasks by status
2. **Basic Navigation**: Simple menu between pages
3. **Essential Layout**: Clean, functional design

### Phase 6: Polish & Testing (2-3 hours)
1. **Responsive Layout**: Ensure mobile compatibility
2. **Basic Error Handling**: Handle common errors gracefully
3. **Final Testing**: Verify core functionality works

**Total: 21-28 hours** (targeting 20-25 hours with efficient development)
